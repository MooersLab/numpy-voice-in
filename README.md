![Version](https://img.shields.io/static/v1?label=numpy-voice-in&message=0.1&color=brightcolor)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://opensource.org/licenses/MIT)


# Library of voice-triggered code snippets for numpy using Voice-In Plus

## Usage

- Open the *numpy.csv* file in a text editor or in the raw view on GitHub.
